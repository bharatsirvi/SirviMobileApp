...
class DeleteConfirmationDialog extends StatefulWidget {
  ...
  const DeleteConfirmationDialog({required this.item});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10),
              Text(
                LocaleData.deleteConfirmation.getString(context),
                style: TextStyle(
                  fontSize: 22,
              ...
              SizedBox(height: 10),
              Text(
                LocaleData.deleteConfirmationMessage.getString(context),
